...
@Component({
    selector: 'edit-data-source-column',
    templateUrl: './edit-data-source-column.component.html',
	changeDetection: ChangeDetectionStrategy.OnPush,
    styleUrls: ['./edit-data-source-column.component.css']
})
//https://github.com/raceconditionrunning/raceconditionrunning.github.io/blob/main/pages/light-rail-relay-24.html#L1143
//RelayResultsTable
export class EditDataSourceColumnComponent implements OnInit, OnDestroy,AfterViewInit,OnChanges  {
